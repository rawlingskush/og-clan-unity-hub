	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'scanner-pulse-fast': 'scanner-pulse-fast 2s linear infinite',
				'scanner-pulse-fast-reverse': 'scanner-pulse-fast-reverse 2s linear infinite',
