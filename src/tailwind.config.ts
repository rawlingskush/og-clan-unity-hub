	...
	theme: {
		...
		extend: {
			...
			fontFamily: {
				...
				orbitron: ['Orbitron', 'sans-serif'], // Keeping Orbitron for hero section
				play: ['Play', 'sans-serif'] // Adding Play font for body text
			},
			dropShadow: {
            ...
            textShadow: {
                'tactical': '0 0 5px rgba(212, 175, 55, 0.5), 0 0 8px rgba(212, 175, 55, 0.3)'
            }
		}
	},
