    ...
    <AnimatedContent animation="fade-in-up" delay={900}>
      <div className="mt-8 md:mt-10 flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-3 sm:mt-0">
          <a href="#og-battle-night" className="inline-flex items-center justify-center px-4 sm:px-6 py-3 border border-ogclan/30 rounded-lg text-ogclan bg-black/50 hover:bg-black/70 transition-colors">
