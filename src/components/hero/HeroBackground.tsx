...
const HeroBackground = () => {
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-[url('https://images.unsplash.com/photo-1560253023-3ec5d502959f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center opacity-15 mix-blend-overlay"></div>
      
      {/* Tech grid overlay */}
      <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30 mix-blend-overlay"></div>
      
      {/* Logo watermark background with slightly reduced opacity */}
      ...
      {/* Tech circuit lines that animate */}
      ...
      {/* Gaming-themed overlay gradient */}
      ...
      {/* Neon-like tech accents */}
      <div className="absolute top-40 -right-40 w-96 h-96 bg-blue-500/20 opacity-50 rounded-full blur-3xl animate-pulse-slow"></div>
      <div className="absolute bottom-20 -left-40 w-96 h-96 bg-ogclan/20 opacity-40 rounded-full blur-3xl animate-pulse-slow animation-delay-600"></div>
