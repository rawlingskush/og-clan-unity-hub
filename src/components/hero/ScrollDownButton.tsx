  ...
  return (
    <AnimatedContent animation="fade-in-up" delay={1200}>
      <button
        ...
        className="group relative rounded-full p-2 bg-black/40 border border-ogclan/20 
      ...
      >
        ...
        <ChevronDown className="h-4 w-4 text-ogclan group-hover:text-ogclan-light group-hover:drop-shadow-gold transition-all duration-300 group-hover:scale-110" />
      </button>
    </AnimatedContent>
  );
};
