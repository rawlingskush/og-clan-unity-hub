  ...
  return (
    <AnimatedContent animation="fade-in-up" delay={1200}>
      ...
      >
        ...
        <ChevronDown className={`${isMobile ? 'h-3.5 w-3.5' : 'h-4 w-4'} text-ogclan group-hover:text-ogclan-light group-hover:drop-shadow-gold-lg transition-all duration-300 group-hover:scale-110 animate-float`} />
      </button>
    </AnimatedContent>
  );
};
