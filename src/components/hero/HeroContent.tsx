      ...
      <AnimatedContent animation="fade-in-up" delay={300}>
        <h1 className={`text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-2 md:mb-3 relative ${isMobile ? 'px-3' : ''}`}>
          <span className="relative inline-block overflow-hidden group">
            ...
            {/* Enhanced glitch effect with higher intensity */}
            <span className="absolute inset-0 bg-clip-text text-transparent bg-gradient-to-r from-red-500/60 via-ogclan/60 to-blue-500/60 blur-[2px] animate-pulse opacity-30 group-hover:opacity-80 transition-opacity duration-300"></span>
        ...
        <p className="text-xl sm:text-2xl md:text-3xl text-ogclan-light font-semibold flex items-center justify-center gap-2 relative">
          ...
          <Flame className="inline-block h-5 w-5 md:h-6 md:w-6 text-red-500 animate-[pulse_2s_ease-in-out_infinite]" />
          
          {/* Enhanced tech accents with increased glow */}
          <span className="absolute -right-4 top-1/2 h-[5px] w-[5px] rounded-full bg-red-500 shadow-[0_0_15px_red] animate-pulse-slow"></span>
          <span className="absolute -left-4 top-1/2 h-[5px] w-[5px] rounded-full bg-blue-500 shadow-[0_0_15px_blue] animate-pulse-slow animation-delay-600"></span>
        </p>
      </AnimatedContent>

      <AnimatedContent animation="fade-in-up" delay={600}>
        <div className="flex items-center justify-center mt-3 mb-5">
          <Gamepad2 className="h-6 w-6 text-ogclan mr-2 animate-[pulse_3s_ease-in-out_infinite]" />
          <span className="text-xl md:text-2xl font-orbitron text-ogclan animate-pulse-slow relative">
            CALL OF DUTY MOBILE
            <Zap className="absolute -right-7 top-0 h-4 w-4 text-ogclan-light animate-[pulse_1.5s_ease-in-out_infinite]" />
          </span>
        </div>
