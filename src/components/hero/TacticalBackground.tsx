...
const TacticalBackground = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-6 left-6 w-12 h-12 border border-ogclan/20 opacity-20">
      ...
      <div className="absolute top-6 right-6 w-12 h-12 border border-ogclan/20 opacity-20">
