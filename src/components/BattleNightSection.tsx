...
const BattleNightSection = () => {
  return <section id="og-battle-night" className="py-16 md:py-20 bg-gradient-to-b from-black/95 to-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          <AnimatedContent animation="fade-in-up">
            ...
            <p className="text-lg md:text-xl text-ogclan-light max-w-2xl mx-auto">Join our Battle Royal gaming event - where legends are born</p>
          </AnimatedContent>
        </div>
