...
const EnhancedHeroSection = ({
  ...
  return <motion.div ref={containerRef} style={{
    ...
    y
      ...
      <motion.div className="absolute inset-0 z-0 opacity-40 bg-[url('/lovable-uploads/ca8b1db8-bd70-4f24-b900-6b87f878e42b.png')] bg-cover bg-center bg-no-repeat" style={{
      x,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center justify-center min-h-[80vh]">
        {/* Main HUD Interface */}
        <motion.div className="relative w-full max-w-5xl" initial={{
        opacity: 0,
        y: 50
      }} animate={{
        ...
        ease: "easeOut"
          ...
          <div className="relative mb-6 sm:mb-8 md:mb-12 p-4 sm:p-6 md:p-8 border border-ogclan/50 bg-black/70 backdrop-blur-md card-3d hover-glow">
            ...
            <div className="text-center mb-6 sm:mb-8">
              <motion.div className="flex items-center justify-center space-x-2 sm:space-x-4 md:space-x-8 mb-4 sm:mb-6 flex-wrap gap-2" initial={{
              scale: 0.8,
              opacity: 0
            }} animate={{
              scale: 1,
              ...
              duration: 0.8
                ...
                {[Target, Shield, Zap, Users, Radar, Eye].map((Icon, index) => <motion.div key={index} whileHover={{
                scale: 1.2,
                rotate: 180
              }} whileTap={{
                scale: 1.1
              ...
              <motion.h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-gradient-enhanced text-glow-tactical mb-3 sm:mb-4 text-glitch font-bold leading-tight" initial={{
              opacity: 0,
              y: 30
            }} animate={{
              opacity: 1,
              ...
              delay: 0.7,
              duration: 1
            }}>ELITE ФƓ TACTICAL UNIT</motion.h1>
              
              <motion.div className="flex items-center justify-center space-x-2 sm:space-x-4 mb-4 sm:mb-6" initial={{
              opacity: 0
            }} animate={{
              opacity: 1
            }} transition={{
              ...
              duration: 0.8
                ...
                <motion.div className="h-px bg-gradient-to-r from-transparent via-ogclan to-transparent flex-1 max-w-8 sm:max-w-16 md:max-w-none" initial={{
                scaleX: 0
              }} animate={{
                scaleX: 1
              }} transition={{
              ...
              <motion.div className="text-xs sm:text-sm md:text-base font-mono text-gray-300 tracking-wide space-y-1 sm:space-y-0 sm:space-x-2 flex flex-col sm:flex-row items-center justify-center" initial={{
              opacity: 0
            }} animate={{
              opacity: 1
            }} transition={{
