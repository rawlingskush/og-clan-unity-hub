...
const clanMembers: ClanMember[] = [
  { name: 'ѲǤゝ21', status: 'ACTIVE' },
  { name: 'ѲǤゝ23', status: 'ACTIVE' },
  { name: 'ѲǤゝ1BTG', status: 'ACTIVE' },
  { name: 'ѲǤゝAKAZA', status: 'ACTIVE' },
  { name: 'ѲǤゝALVES', status: 'ACTIVE' },
  { name: 'ѲǤゝAMMI', status: 'ACTIVE' },
  { name: 'ѲǤゝBEBERIA', status: 'ACTIVE' },
  { name: 'ѲǤゝBLACKSAVAGE', status: 'ACTIVE' },
  { name: 'ѲǤゝBOTGIRL', status: 'ACTIVE' },
  { name: 'ѲǤゝBOTLORDD', status: 'ACTIVE' },
  { name: 'ѲǤゝBUNNY', status: 'INACTIVE (PERSONAL)' },
  { name: 'ѲǤゝCHAKRA', status: 'ACTIVE' },
  { name: 'ѲǤゝCHAMBAS', status: 'ACTIVE' },
  { name: 'ѲǤゝCOD~MIKKI', status: 'ACTIVE' },
  { name: 'ѲǤゝCONQUEST', status: 'ACTIVE' },
  { name: 'ѲǤゝDAMAGE', status: 'ACTIVE' },
  { name: 'ѲǤゝDCPIKIN', status: 'ACTIVE' },
  { name: 'ѲǤゝDED', status: 'ACTIVE' },
  { name: 'ѲǤゝDAHMER', status: 'ACTIVE' },
  { name: 'ѲǤゝDIAN', status: 'ACTIVE' },
  { name: 'ѲǤゝDRIPPA', status: 'ACTIVE' },
  { name: 'ѲǤゝESQUARE', status: 'ACTIVE' },
  { name: 'ѲǤゝEXODUSK', status: 'INACTIVE (PERSONAL)' },
  { name: 'ѲǤゝFAVORITE', status: 'ACTIVE' },
  { name: 'ѲǤゝFIXED', status: 'INACTIVE (PERSONAL)' },
  { name: 'ѲǤゝGAMEHOUSE', status: 'ACTIVE' },
  { name: 'ѲǤゝHARDMIKE', status: 'ACTIVE' },
  { name: 'ѲǤゝHARRIS', status: 'ACTIVE' },
  { name: 'ѲǤゝHATED', status: 'ACTIVE' },
  { name: 'ѲǤゝICON', status: 'ACTIVE' },
  { name: 'ѲǤゝK^VIEN77', status: 'ACTIVE' },
  { name: 'ѲǤゝKAPPA', status: 'ACTIVE' },
  { name: 'ѲǤゝKNIGHT', status: 'INACTIVE (PERSONAL)' },
  { name: 'ѲǤゝKUSH', status: 'ACTIVE' },
  { name: 'ѲǤゝLG-ACE', status: 'ACTIVE' },
  { name: 'ѲǤゝLIL OP', status: 'ACTIVE' },
  { name: 'ѲǤゝLILNASTY', status: 'ACTIVE' },
  { name: 'ѲǤゝLUCIFER', status: 'ACTIVE' },
  { name: 'ѲǤゝLIYZEEY', status: 'ACTIVE' },
  { name: 'ѲǤゝMAFIA', status: 'ACTIVE' },
  { name: 'ѲǤゝMAJOR', status: 'ACTIVE' },
  { name: 'ѲǤゝZEUS', status: 'ACTIVE' },
  { name: 'ѲǤゝMADDOG', status: 'ACTIVE' },
  { name: 'ѲǤゝMENACE', status: 'ACTIVE' },
  { name: 'ѲǤゝMŪŁŁER', status: 'ACTIVE' },
  { name: 'ѲǤゝMULLERYT', status: 'ACTIVE' },
  { name: 'ѲǤゝNO_FACE', status: 'ACTIVE' },
  { name: 'ѲǤゝNOOB', status: 'ACTIVE' },
  { name: 'ѲǤゝNOVAX', status: 'ACTIVE' },
  { name: 'ѲǤゝOLOSHO', status: 'ACTIVE' },
  { name: 'ѲǤゝOWNER', status: 'ACTIVE' },
  { name: 'ѲǤゝPATO', status: 'ACTIVE' },
  { name: 'ѲǤゝPINKY', status: 'ACTIVE' },
  { name: 'ѲǤゝPUNISHER', status: 'ACTIVE' },
  { name: 'ѲǤゝRAMZY', status: 'ACTIVE' },
  { name: 'ѲǤゝREMA237', status: 'ACTIVE' },
  { name: 'ѲǤゝREXO', status: 'ACTIVE' },
  { name: 'ѲǤゝRICHBOY', status: 'ACTIVE' },
  { name: 'ѲǤゝRUNTOWN', status: 'ACTIVE' },
  { name: 'ѲǤゝSAVAGE', status: 'ACTIVE' },
  { name: 'ѲǤゝSHADOW', status: 'ACTIVE' },
  { name: 'ѲǤゝSHINØBI', status: 'ACTIVE' },
  { name: 'ѲǤゝSL1M', status: 'ACTIVE' },
  { name: 'ѲǤゝSLIM SHADY', status: 'ACTIVE' },
  { name: 'ѲǤゝSMOKE', status: 'ACTIVE' },
  { name: 'ѲǤゝSNAKESEYES', status: 'INACTIVE (PERSONAL)' },
  { name: 'ѲǤゝSPARK', status: 'ACTIVE' },
  { name: 'ѲǤゝSTAIN', status: 'INACTIVE (PERSONAL)' },
  { name: 'ѲǤゝSUSPECT', status: 'ACTIVE' },
  { name: 'ѲǤゝSWIZZY', status: 'ACTIVE' },
  { name: 'ѲǤゝTELOS', status: 'ACTIVE' },
  { name: 'ѲǤゝTEDDY', status: 'ACTIVE' },
  { name: 'ѲǤゝUNCLE B', status: 'ACTIVE' },
  { name: 'ѲǤゝVENOM', status: 'ACTIVE' },
  { name: 'ѲǤゝWHITE', status: 'INACTIVE (PERSONAL)' },
  { name: 'ѲǤゝWIZARD', status: 'ACTIVE' },
];
