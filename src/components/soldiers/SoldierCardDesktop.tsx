...
import { generateDeterministicStats, getAccentColor } from './utils/soldierStats';
...
const SoldierCardDesktop = ({ 
  ...
  const accentColor = getAccentColor(soldier.weapon);

  // Function to toggle quick stats on desktop
