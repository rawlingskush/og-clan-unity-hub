...
const SoldierCard = ({ soldier, isActive = false }: SoldierCardProps) => {
  ...
  // Quick stats data with enhanced elite values
  const stats = {
    ...
    >
      ...
      >
        <div className="relative">
          ...
          <CardFooter className="flex justify-center p-2 bg-ogclan/10 border-t border-ogclan/20 card-footer">
            <a 
    ...
    >
      ...
      >
        <div className="relative">
          ...
          <CardFooter className="flex justify-center p-2 bg-ogclan/10 border-t border-ogclan/20 card-footer z-20 relative">
            <a 
              href={soldier.tiktokUrl} 
              target="_blank" 
              rel="noopener noreferrer"
